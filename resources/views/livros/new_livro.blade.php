...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col">
            ...
            <form action="{{ route('newLivroSubmit') }}" method="post">
                @csrf
                    ...
                    <div class="col">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control bg-primary text-white" name="numero_paginas" value="{{ old('numero_paginas') }}">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control bg-primary text-white" name="edicao" value="{{ old('edicao') }}">
                                @error('edicao')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control bg-primary text-white" name="data_publicacao" value="{{ old('data_publicacao') }}">
